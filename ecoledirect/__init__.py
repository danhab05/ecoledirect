...
class Ecoledirect_bot:
    ...
    def login(self):
        ...
        nameInput = self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[1]/div/div/div[1]/div[3]/form/input[1]')
        passInput = self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[1]/div/div/div[1]/div[3]/form/input[2]')
        nameInput.send_keys(self.username)
        passInput.send_keys(self.password)
        button = self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[1]/div/div/div[1]/div[3]/form/button')
        button.click()
        time.sleep(2)
    ...
    def get_homework(self):
        ...
        self.driver.find_element_by_xpath(
            "/html/body/div[2]/div[1]/div/ed-menu[2]/div/a/div").click()
        self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[1]/div/ed-menu[2]/div/div/ul/li[7]/a'
        ).click()
        # SEMAINE
        time.sleep(1)
        self.driver.find_element_by_xpath(
            '/html/body/div[2]/div[2]/div[2]/cahier-de-texte/div/div[1]/div[2]/div[2]/ul/li[10]/a'
        ).click()
        time.sleep(2)
